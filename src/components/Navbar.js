...
export default class Navbar extends Component {
    render() {
        return (
            <NavWrapper className="navbar navbar-expand-sm bg-primary navbsr-dark px-sm-5">
                {/* 
                ...
                */}
                ...
                <ul className="navbar-nav align-items-center text-secondary">
